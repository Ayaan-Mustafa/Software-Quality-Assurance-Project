...
| Frontend suite naming | Test organization and pairing | Non-standard filename/directory conventions (`output/`, mixed extensions) | Mixed naming patterns | Standardized to `input/<case>.in.txt`, `expected_output/<case>.exp.txt`, `expected_atf/<case>.atf`; runner enforces strict basename pairing |
